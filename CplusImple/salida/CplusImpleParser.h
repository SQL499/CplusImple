...
class  CplusImpleParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleProg = 0, RuleInclude = 1, RuleMainDef = 2, RuleFuncDef = 3, RuleParamList = 4, 
    RuleStat = 5, RuleAssignment = 6, RuleExpr = 7, RuleArithmetic = 8, 
    RuleTerm = 9, RuleFactor = 10, RuleIfStat = 11, RuleIfBody = 12, RuleElseStat = 13, 
    RuleElseBody = 14, RuleWhileStat = 15, RuleWhileBody = 16, RuleForStat = 17, 
    RuleForInit = 18, RuleForCondition = 19, RuleForIncrement = 20, RuleForBody = 21, 
    RuleCondition = 22, RuleRelOp = 23, RulePrintExpr = 24, RuleInputExpr = 25, 
    RuleFuncCall = 26, RuleArgList = 27, RulePrintList = 28, RuleEndin = 29
  };

  explicit CplusImpleParser(antlr4::TokenStream *input);

  CplusImpleParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~CplusImpleParser() override;
  ...
  class  MainDefContext : public antlr4::ParserRuleContext {
  public:
    MainDefContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    EndinContext *endin();
  ...
  class  WhileBodyContext : public antlr4::ParserRuleContext {
  public:
    WhileBodyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<StatContext *> stat();
    StatContext* stat(size_t i);
  ...
  class  InputExprContext : public antlr4::ParserRuleContext {
  public:
    InputExprContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<antlr4::tree::TerminalNode *> ID();
    antlr4::tree::TerminalNode* ID(size_t i);
  ...
  class  EndinContext : public antlr4::ParserRuleContext {
  public:
    EndinContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ExprContext *expr();
